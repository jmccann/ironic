...
cookbook 'openstack-common', git: 'git@github.com:stackforge/cookbook-openstack-common.git'
cookbook 'openstack-ops-database', git: 'git@github.com:stackforge/cookbook-openstack-ops-database.git'
